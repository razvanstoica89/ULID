...
class Ulid
{
     ...
     * Lowercase ULIDs are slightly smaller in terms of storage size, since they use 26 characters instead of 36.
     * This could be a factor if you need to store a large number of ULIDs and are concerned about space efficiency.
     */
     ...
     */
    public static function generate(bool $uppercase = false): string
    {
     ...
     * @return array<string, int> An array containing the decoded timestamp and random values.
     */
